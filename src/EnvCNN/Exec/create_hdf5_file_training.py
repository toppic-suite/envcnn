...
data_files, labels = util.shuffle_data(labels_dict) 
train_data_files, validation_data_files, test_data_files, train_labels, validation_labels, test_labels = util.split_data_single(data_files, labels)

hdf5_path = "dataset_train.hdf5"
