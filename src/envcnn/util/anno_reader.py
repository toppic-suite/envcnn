...
def _read_feature_header(env_lines):
  peak_id = -1
  spec_id = -1
  topfd_score = -1
  charge = -1
...
def _parse_envelope(env_lines):
  header = _read_feature_header(env_lines)
